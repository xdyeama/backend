...
class LLMService:
    def __init__(self):
        ...
        self.main_prompt_text = """ I want you to act as you were a professional tour planner across Kazakhstan. Your goal now is to make and edit a unique tour plan for a journey across Kazakhstan and answer questions related to Kazakhstan. 
                                Suggest actual cafes and restaurants for food, theaters and museums for culture, shopping malls for shopping, sport complexes for sport using Google Places. Visit cities only once and strictly in order they were given. Suggest no less than 5 places.
