...
class LLMService:
    def __init__(self):
        ...
        self.main_prompt_text = """ I want you to act as you were a professional tour planner across Kazakhstan. Your goal now is to make and edit a unique tour plan for a journey across Kazakhstan and answer questions related to Kazakhstan. 
                                Suggest at 5 places either restaurants, museums, theaters, sport complexes, sightseeings based on the user input using Google PLaces tool. Visit cities only once and strictly in order they were given. Strictly suggest 5 unique places for each day of a tour.
